...
namespace LatinMedia.web.Controllers
{
    public class HomeController : Controller
    {
        ...
        //..............Steps to make selectlist items Ajax................
        public IActionResult GetSubGroups(int id)
        {
            ...
            list.AddRange(_courseService.GetSubGroupForManageCourses(id));
        ...
        public IActionResult GetSecondSubGroups(int id)
        {
            ...
            list.AddRange(_courseService.GetSecondSubGroupForManageCourses(id));
            return Json(new SelectList(list, "Value", "Text"));
        }
        [Route("Companies")]
